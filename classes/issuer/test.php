...
<body style="background:#F8F9FA">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <section id="generation_form" style="">
        <div class="container">
<!--            <div class="row">-->
                <div class="" style=" background: #F8F9FA; padding: 50px;  margin-top:60px;">
...
<!--                                <div style="width: 50px; height: 3px; background:#204a84; margin-bottom: 15px;"></div>-->
                ...
                <!--End of col-md-6-->
<!--
                <div class="col-md-7" style="background-color: #204a84; padding: 50px; position:fixed; top:60; right:0;">
