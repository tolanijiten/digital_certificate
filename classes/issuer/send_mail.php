...
$generation_id=$_SESSION['generation_id'];

if($_SESSION['students']<=0){
    session_unset();
...
//echo "<a href=phpmailer/my_mail.php?generation_id=$generation_id>Next</a>"
...
//    $organisation_name = 'rait';
     $query2 = "select * from $commitee_name where student_id between $start and $end ";
    //echo $query2
    ...
    <div class="container-fluid">
        ...
        ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="<?php echo 'phpmailer/my_mail.php?generation_id='.$generation_id; ?>" class="btn btn-default" style="margin-bottom:50px; background-color: #b0413e; color: white;"> Send Mail <i class="fa fa-check"></i></a>
                    </div>
                </div>
            </div>
            </div>
